...
def main() -> None:
    fusion_path = Path("outputs/nbsdc_fusion/aligned_hourly_fusion.csv")
    ...
    outputs = run_token_export(fusion_path=fusion_path, config=config, output_dir="outputs/token_export")
